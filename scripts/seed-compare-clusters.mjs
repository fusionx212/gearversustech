...
const rows = [
  ...
  a({
    ...
    content_html: body({
      ...
      verdict: `<p>Permanent bay → Mirafit half rack. Shared bay → folding wall. Read <a href="/home-gym/compare//">2.4m ceiling constraints</a> before you buy.</p>`,
      related: [
        { href: '/home-gym/compare//', label: 'Mirafit vs Rogue UK' },
        { href: '/home-gym/compare//', label: 'Garage gym under 2.4m' },
        { href: '/home-gym/compare//', label: 'Wall-mount vs freestanding' },
      ],
    }),
  }),
  a({
    ...
    content_html: body({
      ...
      verdict: `<p>Garage with height → Mirafit path. Spare room → adjustable dumbbells. See also <a href="/home-gym/compare//">under £500</a> and <a href="/home-gym/compare//">under £2,500</a>.</p>`,
      related: [
        { href: '/home-gym/compare//', label: 'Home gym under £500' },
        { href: '/home-gym/compare//', label: 'Home gym under £2,500' },
        { href: '/home-gym/compare//', label: 'Adjustable dumbbells H2H' },
      ],
    }),
  }),
  a({
    ...
    content_html: body({
      ...
      verdict: `<p>Build Mirafit complete. Add Rogue later if the bay is permanent and money is secondary. Pair with <a href="/home-gym/compare//">terrace flooring</a>.</p>`,
      related: [
        { href: '/home-gym/compare//', label: 'Mirafit vs Rogue' },
        { href: '/home-gym/compare//', label: 'Best single-garage rack' },
        { href: '/home-gym/compare//', label: 'Under £1,000 path' },
      ],
    }),
  }),
  a({
    ...
    content_html: body({
      ...
      verdict: `<p>Buy adjustable dumbbells for a real spare-room gym. Add kettlebells later for swings. Start lighter in <a href="/home-gym/compare//">under £500</a>.</p>`,
      related: [
        { href: '/home-gym/compare//', label: 'Home gym under £500' },
        { href: '/home-gym/compare//', label: 'Under £1,000' },
        { href: '/home-gym/compare//', label: 'Neighbour-friendly cardio' },
      ],
    }),
  }),
  a({
    ...
    content_html: body({
      ...
      related: [
        { href: '/home-gym/compare//', label: 'Best single-garage rack' },
        { href: '/home-gym/compare//', label: 'Under 2.4m ceiling' },
        { href: '/home-gym/compare//', label: 'Mirafit vs Rogue' },
      ],
    }),
  }),
  a({
    ...
    content_html: body({
      ...
      verdict: `<p>Quiet homes win with low-impact machines + mats. Pair any buy with <a href="/home-gym/compare//">terrace flooring guidance</a>.</p>`,
      related: [
        { href: '/home-gym/compare//', label: 'Rubber flooring for terraces' },
        { href: '/home-gym/compare//', label: 'Under £500 starter' },
        { href: '/home-gym/compare//', label: 'Adjustable dumbbells' },
      ],
    }),
  }),
